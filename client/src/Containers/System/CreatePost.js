...
const CreatePost = ({ isEdit }) => {
  ...
  return (
    <div className="px-8 py-6 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold py-6 border-b border-gray-300">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mt-6">
        ...
        <div className="lg:w-[30%] w-full h-[400px] bg-white rounded-xl shadow-md p-4 flex items-center justify-center text-gray-500 text-lg border">
          Bản Đồ
        </div>
      </div>
    </div>
